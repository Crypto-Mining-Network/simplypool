...
GRANT ALL ON pool.* TO pool IDENTIFIED BY '${MYSQL_POOL_USER_PASSWORD}';
FLUSH PRIVILEGES;
USE pool;
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('daemon', 'address', 'monero_daemon.main.pool', 'string', 'Monero Daemon RPC IP');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('daemon', 'port', '18081', 'int', 'Monero Daemon RPC Port');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('wallet', 'address', 'monero_wallet.main.pool', 'string', 'Monero Daemon RPC Wallet IP');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('wallet', 'port', '8082', 'int', 'Monero Daemon RPC Wallet Port');
